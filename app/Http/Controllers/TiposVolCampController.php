...
class TiposVolCampController extends Controller
{
    ...
    public function editStatus(Request $request, $id)
    {
        ...
        $request->validate([
            'statusVC' => 'required|in:Activo,Inactivo', // Agregado para validar el campo 'status'
        ]);
    
        // Asignar el valor solo si está presente en la solicitud
        $tiposVolCamp->statusVC = $request->input('statusVC', $tiposVolCamp->statusVC); // Campo 'status' agregado
